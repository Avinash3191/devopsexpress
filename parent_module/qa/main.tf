...
module "module_bastion_host" {
  ...
  azure_bastion_name            = var.azure_bastion_name
  location                      = var.location
  rg_name                       = var.rg_name
  bastion_ip_configuration_name = var.bastion_ip_configuration_name
  bastion_subnet_id             = module.module_bastion_subnet.subnet_id
  # public_ip_address_id          = module.module_bastion_public_ip.public_ip_id
  public_ip_address_id          = module.module_bastion_public_ip.pip_id
